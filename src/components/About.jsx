...
const About = () => {
  ...
  return (
    <section
      id="about"
      className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 py-20 px-4 md:px-8 text-white"
    >
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="w-full lg:w-1/2 space-y-6 text-gray-300">
            ...
            {/* Intro */}
            <p data-aos="fade-up" data-aos-delay="100" className="leading-relaxed">
              Hi! I'm a{" "}
            ...
            {/* Skills */}
            <p data-aos="fade-up" data-aos-delay="200" className="leading-relaxed">
              I specialize in{" "}
              <span className="font-semibold text-indigo-400">
                React.js, Node.js, Express.js, MongoDB, REST APIs
              </span>{" "}
              and modern development practices to create fast, responsive,
              and user-friendly applications.
            </p>

            {/* DevOps */}
            <p data-aos="fade-up" data-aos-delay="300" className="leading-relaxed">
              I also work with{" "}
              <span className="font-semibold text-cyan-400">
            ...
            {/* Passion */}
            <p data-aos="fade-up" data-aos-delay="400" className="leading-relaxed">
            ...
            {/* Education */}
            <p data-aos="fade-up" data-aos-delay="500" className="leading-relaxed">
              <strong className="text-white">Education:</strong> BCA,
              Aryabhatta Knowledge University
              <br />
              <strong className="text-white">Hobbies:</strong> Coding,
              backend development, cloud computing, exploring DevOps tools,
            ...
            <div data-aos="fade-up" data-aos-delay="600">
              <a
                ...
                className="inline-block px-6 py-3 rounded-xl bg-indigo-500 hover:bg-indigo-600 text-white font-medium shadow-lg hover:shadow-indigo-500/40 transition duration-300"
              >
                View Resume
              </a>
            </div>
        ...
        <div
          ...
          data-aos-delay="700"
        >
          <h3 className="text-2xl md:text-3xl font-bold text-center text-indigo-400 mb-12">
            My Journey
          </h3>
          ...
          <div className="relative border-l-4 border-indigo-500 pl-8 space-y-12">
            ...
            <div data-aos="fade-right" data-aos-delay="200">
              ...
              <p className="text-gray-300 mt-2">
                Bachelor of Computer Applications (BCA) – Aryabhatta
